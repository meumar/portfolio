...
export async function GET(req: Request) {
    const response = {
        ...
        skills: ["Solana", "Anchor", "Rust", "Vue.js", "Nuxt.js", "React", "Next.js", "Node.js", "React Native"],
        ...
        languages: [
            {
                name: "Solana",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/solana.png"
            },
            {
                name: "Rust",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/rust.png"
            },
            {
                name: "Anchor",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/anchor.png"
            },
            {
                name: "Vue",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/vue.png"
            },
            {
                name: "Nuxt",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/nuxt.png"
            },
            {
                name: "React",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/react.png"
            },
            {
                name: "Next",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/next.png"
            },
            {
                name: "Node",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/node.png"
            },
            {
                name: "MongoDB",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/images/mongodb.png"
            },
        ],
        links: {
            resume: "https://drive.google.com/file/d/1M9yH8Ov2GXhZ49nCUSQdQM57Usp0kJso/view?usp=sharing",
        ...
        projects: [
            {
                ...
                image: "https://raw.githubusercontent.com/meumar/my-files/main/projects/multi-sign.png",
                git: "https://github.com/meumar/multi-sign",
                description: "This is a multi-signature wallet application built on the Solana blockchain using the Anchor framework. The application allows users to create wallets with multiple members, set a transaction approval threshold, send SOL to the wallet, and transfer SOL from the wallet to other addresses with the required approval from members. Users can also view the transaction history of the wallet.",
                technologies: ["React", "Next.js", "Rust", "Anchor", "Tailwind"]
            },
            {
                name: "GOT NFT Marketplace",
                link: "https://got-nft.vercel.app",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/projects/nft-marketplace.png",
                git: "https://github.com/meumar/got-nft",
                description: "This application enables users to create and trade NFTs of anything related to the Game of Thrones universe. Users can mint their own NFTs by uploading images, set their desired prices, and engage in buying and selling within the marketplace.",
                technologies: ["React", "Next.js", "Rust", "Anchor", "Tailwind"]
            },
            {
                name: "Profit swap",
                link: "https://sol-profit.vercel.app",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/projects/profit-sol.png",
                git: "https://github.com/meumar/sol-profit",
                description: "This is a application to display real-time token prices across DEXs on Solana for profit calculation for better swap price using React.js. Integrated Jupitor, Orca, and Raydium for the proof of concept.",
                technologies: ["React", "Tailwind "]
            },
            {
                name: "Tik-Tac-Sol",
                link: "https://tik-tac-sol.vercel.app",
                image: "https://raw.githubusercontent.com/meumar/my-files/main/projects/tic-tak-sol.png",
                git: "https://github.com/meumar/tik-tac-sol",
                description: "This project implements a simple game on the Solana blockchain using the Anchor framework for the smart contract and Next.js for the user interface (UI). The game allows users to connect their wallets, create or join a game, and bet SPL tokens. The game is designed for two players, and the winner takes the total bet amount. If the game ends in a draw, the bet amount is returned to each player.",
                technologies: ["React", "Next.js", "Rust", "Anchor", "Tailwind"]
            }
        ]
    }
